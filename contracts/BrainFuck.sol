...
contract BrainFuck {
     ...
     *    [255 .. instruction .. 248][247 .. value .. 0]
     *    [255 .. instruction .. 248][247 .. value .. 0]
     *                      ....
     *    Where:
     *      `instruction` is a brainfuck instruction and occupies the leftmost byte.
     *      `value` is the argument to `instruction` and occupies the rightmost 31 bytes.
     *
     *    When combined [`instruction`|`value`] occupies 1 word of memory (32 bytes).
